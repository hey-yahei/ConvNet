...
class Model {
private:
	CBConvolution* conv1, * conv2, * conv3;
	CBFullyConnection* fc1, * fc2;
	Pooling* pool;
	Eltwise* elt;
	Concat* cat;
...
public:
	Model() {
		...
		conv1 = new CBConvolution(3, 2, 1, 12, 1, in_shape, true, false, 5);
		conv1->GetOutputShape(shape);
		conv2 = new CBConvolution(5, 1, 2, 12, 2, shape, true, true, 5);
		conv2->GetOutputShape(shape);
		elt = new Eltwise("add", shape, false);
		elt->GetOutputShape(shape_);
		conv3 = new CBConvolution(1, 1, 0, 6, 1, shape, true, false, 5);
		...
		fc1 = new CBFullyConnection(100, shape, true, false, true, 5);
		fc1->GetOutputShape(shape);
		fc2 = new CBFullyConnection(10, shape, false, true, false, 5);


		conv1->LoadWeightFromFile("../models/my_testmodel/conv1.weight.dat5", true);
		conv1->LoadCodebookFromFile("../models/my_testmodel/conv1.weight.codebook.dat");

		conv2->LoadWeightFromFile("../models/my_testmodel/conv2.weight.dat5", true);
		conv2->LoadCodebookFromFile("../models/my_testmodel/conv2.weight.codebook.dat");
		conv2->LoadBiasFromFile("../models/my_testmodel/conv2.bias.dat");

		conv3->LoadWeightFromFile("../models/my_testmodel/conv3.weight.dat5", true);
		conv3->LoadCodebookFromFile("../models/my_testmodel/conv3.weight.codebook.dat");

		fc1->LoadWeightFromFile("../models/my_testmodel/fc1.weight.dat5", true);
		fc1->LoadCodebookFromFile("../models/my_testmodel/fc1.weight.codebook.dat");

		fc2->LoadWeightFromFile("../models/my_testmodel/fc2.weight.dat5", true);
		fc2->LoadCodebookFromFile("../models/my_testmodel/fc2.weight.codebook.dat");
